...
# Cargar datos
df_copa_2024 = pd.read_csv('app-streamlit/Argentina Copa de la Liga 2024.csv')
df_lpf_2024 = pd.read_csv('app-streamlit/Argentina LPF 2024.csv')
df_reserva_2024 = pd.read_csv('app-streamlit/Argentina Reserve League 2024.csv')
